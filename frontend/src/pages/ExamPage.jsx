...
//     .then((response) => {
//       console.log("Teachers response:", response);  // Log to inspect full response
...
//         <select name="supervisors" multiple value={formData.supervisors} onChange={handleSupervisorChange} required>
